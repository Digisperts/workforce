            ...
            <div>
                ...
                <div className="flex justify-between bg-white border shadow-md border-gray-200 mt-5 border-transparent px-4 py-2 rounded-lg w-full">
                    <div className="flex gap-2 items-center flex-1">
                        <Search className="w-8 h-8 text-[#005B5B] " />
                        <input
                            type="text"
                ...
                {/* ========== Job Cards ======== */}
                <div className=" mt-5  text-[#004646] text-xl font-semibold flex justify-between items-center">
                    <p>Popular Jobs</p>
                    <p className="text-sm text-[#008080] font-semibold cursor-pointer">See all</p>
                </div>
                <div className="mt-5 grid grid-cols-4 gap-5 md:grid-cols-3 sm:grid-cols-1 bg-none items-start">
                    {jobs.map((job, index) => (
                        <CandidateJobCard
                            key={index}
                            job={job}
